 ...
 */
package Views.Patisserie.Recette.MesRecettes.Commentaire;
...
public class CommentaireController implements Initializable {
    ...
    private ModifierRecetteController sRc ;
    ...
    public ModifierRecetteController getsRc() {
        return sRc;
    }

    public void setsRc(ModifierRecetteController sRc) {
        this.sRc = sRc;
    }
    ...
    public void setMrc(ModifierRecetteController mrc) {
        this.mrc = mrc;//cv tet3adda hedhi zeda
    }
    ...
    private void ModifierCommentaire(ActionEvent event) throws IOException, SQLException {
        ...
        vc.setIdCmnt(idCmnt);
        if (mrc == null )
            System.out.println("Views.Patisserie.Recette.MesRecettes.Commentaire.CommentaireController.ModifierCommentaire()");
        vc.setsRc(mrc);
    ...
    private void SupprimerCommentaire(ActionEvent event) throws SQLException, IOException {
        ...
        mrc.AfficherCommentaireReplay(cs.AfficherCommentaire(idRec), cs, "", null);
    }
