 ...
 * @author aziz
 */
public class ModifierRecettePatisserieController implements Initializable {
    ...
    private ModifierRecettePatisserieController mcc ;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(ModifierRecettePatisserieController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public ModifierRecettePatisserieController getMcc() {
        return mcc;
    }

    public void setMcc(ModifierRecettePatisserieController mcc) {
        this.mcc = mcc;
    }
