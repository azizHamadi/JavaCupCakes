 ...
 */
package Views.Patisserie.Produit.StatVente;
 ...
 * @author escobar
 */
public class StateVenteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            for (Produit p : produit) {
                int month = p.getQteAcheter();
                           series.getData().add(new XYChart.Data<>(p.getNomProd(), p.getQteAcheter()));

            }
                                barchar.getData().add(series);

        } catch (SQLException ex) {
            Logger.getLogger(StateVenteController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
