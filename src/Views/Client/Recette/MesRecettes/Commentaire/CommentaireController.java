 ...
 */
package Views.Client.Recette.MesRecettes.Commentaire;
...
public class CommentaireController implements Initializable {
    ...
    private void ModifierCommentaire(ActionEvent event) throws IOException, SQLException {
        ...
        vc.setIdCmnt(idCmnt);
        if (mrc == null )
            System.out.println("Views.Client.Recette.MesRecettes.Commentaire.CommentaireController.ModifierCommentaire()");
        vc.setsRc(mrc);
